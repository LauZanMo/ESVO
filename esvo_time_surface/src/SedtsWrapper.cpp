...
SedtsWrapper::SedtsWrapper(ros::NodeHandle &nh, ros::NodeHandle nh_private) : nh_(nh) {
    ...
    nh_private.param<double>("decay_sec", decay_sec_, 0.02);
    nh_private.param<double>("tau_scale", tau_scale_, 8.0);
    nh_private.param<double>("min_tau", min_tau_, 50.0);
    nh_private.param<int>("blur_size", blur_size_, 1);
    ...
    ts_options.blur_size       = blur_size_;
    ts_options.ignore_polarity = ignore_polarity_;
