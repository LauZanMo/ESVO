...
double Sobel::convolve(const Eigen::Matrix3d &kernel, const Eigen::Matrix3d &src) {
    return kernel.cwiseProduct(src).sum();
}

const Eigen::Matrix3d Sobel::sobel_3x3_x =
    (Eigen::Matrix3d() << -1, 0, 1, -2, 0, 2, -1, 0, 1).finished();
const Eigen::Matrix3d Sobel::sobel_3x3_y =
    (Eigen::Matrix3d() << -1, -2, -1, 0, 0, 0, 1, 2, 1).finished();
const Eigen::Matrix<double, 5, 5> Sobel::sobel_5x5_x = (Eigen::Matrix<double, 5, 5>() << -5,
                                                        -4,
                                                        0,
                                                        4,
                                                        5,
                                                        ...
                                                        5)
                                                           .finished();
;
const Eigen::Matrix<double, 5, 5> Sobel::sobel_5x5_y = (Eigen::Matrix<double, 5, 5>() << -5,
                                                        -8,
                                                        -10,
                                                        -8,
                                                        -5,
