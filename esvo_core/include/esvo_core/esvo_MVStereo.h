...
public:
    ...
    void createEdgeMask(std::vector<dvs_msgs::Event *>         &vEventsPtr,
    ...
    void createDenoisingMask(std::vector<dvs_msgs::Event *> &vAllEventsPtr,
                             cv::Mat                        &mask,
                             size_t                          row,
                             size_t                          col);

    void extractDenoisedEvents(std::vector<dvs_msgs::Event *> &vCloseEventsPtr,
...
private:
    ...
    dynamic_reconfigure::Server<DVS_MappingStereoConfig>::CallbackType
