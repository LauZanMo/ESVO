...
struct GyroSolverStruct {
    Eigen::Quaterniond gyro_q;
    Eigen::Quaterniond cam_q;
    Eigen::Matrix3d    dq_dbg;
    GyroSolverStruct() {}
    GyroSolverStruct(const Eigen::Quaterniond _gyro_q,
                     const Eigen::Quaterniond _cam_q,
                     const Eigen::Matrix3d    _dq_dbg)
        : gyro_q(_gyro_q), cam_q(_cam_q), dq_dbg(_dq_dbg) {}
};
